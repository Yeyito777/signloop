...
final class SignloopCameraView: ExpoView {
    ...
    required init(appContext: AppContext? = nil) {
        ...
        modelBundle = bundle
        faceModelAvailable = bundle.path(forResource: "face_landmarker", ofType: "task") != nil
        expressions = GooseExpressionTracker(source: Self.expressionProfile(in: bundle), modelAvailable: faceModelAvailable)
    ...
    private static func expressionProfile(in bundle: Bundle) -> GooseExpressionProfile {
        ...
        return GooseExpressionProfile.load(localURL: local, taughtURL: TaughtExpressionStore.standard.localURL,
    ...
    func synchronize() {
        ...
        lastStatus = ""
        lastEmission = 0
        tracker.trackFace = (trackFace || labMode) && faceModelAvailable
    ...
    private func emitDetection(force: Bool = false) {
        ...
        onDetection([
            ...
            "expression": fresh && tracker.trackFace ? expressions.title : "",
